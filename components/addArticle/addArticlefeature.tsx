...
const AddArticleFeature = ({ onSubmit, onCancel }: AddArticleFeatureProps) => {
  ...
  setFormData((prev: typeof formData) => ({
        ...prev,
  contributors: prev.contributors.filter((_: any, i: number) => i !== index)
      }));
    }
  };
  ...
  setFormData((prev: typeof formData) => ({
      ...prev,
  contributors: prev.contributors.map((contributor: any, i: number) =>
  ...
  setFormData((prev: typeof formData) => ({ ...prev, file }));
    
    // ลบ error ของไฟล์ถ้ามี
    if (file && errors.file) {
  setErrors((prev: typeof errors) => ({ ...prev, file: '' }));
    }
  };
  ...
  formData.contributors.forEach((contributor: any, index: number) => {
    ...
    <div className="w-6/7 flex flex-col justify-center items-center">
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData((prev: typeof formData) => ({ ...prev, ownerFirstName: e.target.value }))}
              />
            ...
            <div>
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData((prev: typeof formData) => ({ ...prev, ownerLastName: e.target.value }))}
              />
        ...
        <div>
          ...
          {formData.contributors.map((contributor: any, index: number) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateContributor(index, 'firstName', e.target.value)}
                  />
